...
import net.deepikaguides.ems.mapper.EmployeeMapper;
import net.deepikaguides.ems.repository.EmployeeRepository;
...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public EmployeeDto getEmployeeById(Long employeeId) {
        Employee employee=employeeRepository.findById(employeeId).orElseThrow(()->new ResourceNotFoundException("Employee is exists with given id: "+employeeId));
    ...
    public void deleteEmployee(Long employeeId) {
        employeeRepository.findById(employeeId).orElseThrow(()->new ResourceNotFoundException("Employee Id not found"+employeeId));
